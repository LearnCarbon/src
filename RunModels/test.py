...
#Load saved model
model = tf.keras.models.load_model('LearnModel.h5')
model.summary()

pathInp = r"C:\Users\ppou\source\repos\AEC_Hackathon2021\query.txt"
inputData = np.genfromtxt(pathInp)

scalerY = joblib.load(r"C:\Users\ppou\source\repos\AEC_Hackathon2021\scalerY.pkl")
scalerX = joblib.load(r"C:\Users\ppou\source\repos\AEC_Hackathon2021\scalerx.pkl")
...
pathOut = r"C:\Users\ppou\source\repos\AEC_Hackathon2021\output\prediction.txt"
